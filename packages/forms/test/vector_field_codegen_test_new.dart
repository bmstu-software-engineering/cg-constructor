...
/// flutter test test/vector_field_codegen_test_new.dart
void main() {
  group('VectorField CodeGen', () {
    late VectorTestFormNewFormConfig formConfig;
    late VectorTestFormNewFormModel formModel;

    setUp(() {
      formConfig = VectorTestFormNewFormConfig();
    ...
    test('Установка и получение значений', () {
      ...
      formModel.values = const VectorTestFormNew(
